...
export const builder: any = {
    ...
    verbose: {
        describe: 'Output console logs that describe which class and method are currently being executed.',
        default: false,
        demandOption: false,
        boolean: true
    },
    processCount: {
        describe: 'The number of processes to use. By default this will use the number of cpu cores available on the os.',
        default: cpus().length,
        demandOption: false,
        number: true,
        nargs: 1
    ...
    headless: {
        describe: 'This option will run the tests with the browser(s) running in the background.',
        demandOption: false,
        boolean: true
    },
    screenWidth: {
    ...
    loadTime: {
        describe: 'Increasing this will increase the wait time before executing any functions.',
        default: 200,
        demandOption: false,
        number: true,
        nargs: 1
